...
development, we do not include such functional code in the statistics.  The core of a ynot module then consists of heap representation
 ...
 these three columns are totaled in the overhead column.  Program code (e.g. getElements) is code that is preserved by extraction. 
 The annotations column counts the number of lines of
 programmer specified annotations (e.g. \texttt{<@>}).  Coqc compilation times (in minutes:seconds) were taken on a 2.8ghz Pentium D 
...
\begin{figure*}
  \begin{center}
    \begin{tabular}{r | r | r | r | r | r | r | r | r}
                                             & Program & Specs & Rep & Proofs & Tactics &  Total Overhead & Annotations & Time (m:s) \\ \hline
Stack                                        &         &       &     &        &         &                 &             & 0:12 \\
Queue                                        &         &       &     &        &         &                 &             & 1:36 \\
