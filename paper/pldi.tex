...
development, we do not include such functional code in the statistics.  The core of a ynot module then consists of heap representation
 ...
 with 1gb of memory.   We have made no effort to optimize our tactics for running time.  
...
Our examples indicate that a variety of tradeoffs between columns are possible, and the linked list segments example suggests that our techniques can be made to scale linearly.   To qualitatively evaluate Ynot we have compared it against two 
