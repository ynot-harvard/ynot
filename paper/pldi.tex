...
%We would like to avoid such explicit framings, and they only remain because it is unclear how to implement our syntax extensions in a way that avoids them.
...
To compare the annotation burden, we consider an {\tt append} function
