...
public class JameResourceSet
{
    ...
    //: private specvar resUntouched :: "(obj * int) set"
    ...
    /*:
     ...
     modifies resSet
     ensures "comment ''goal'' (comment ''target'' (this .. JameResourceSet.resSet) = comment ''source'' (newResources..JameResourceSet.resSet) )"
     */
    // SUCCEEDS
    {
    ...
    /*:
     requires "addRes ~= null & addRes..JameResource.name ~= null"
    ...
    */
	...
	JameResource oldRes = find( addRes.name );
    	if( oldRes != null )
    	{
	        ...
	        // assume "addRes..JameResource.value ~= null"
    ...
    */
    ...
    /*:
     requires "resources ~= null & newRes ~= null & newRes..JameResource.name ~= null" 
     modifies resSet, "JameCollection.collection", "JameCollection.free"
     ensures "
