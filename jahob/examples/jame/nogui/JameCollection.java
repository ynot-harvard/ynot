...
public class JameCollection
{
    ...
    /*: 
      ...
      vardefs "collection == 
         { c . EX n . c = n..JameNode.content & 
                      rtrancl_pt (% x y. JameNode.next x = y) head n}";
    */
    ...
    /*: 
      ...
      vardefs "free == 
        { c . EX n . c = n..JameNode.content & ( current, n ) : rtrancl ( fgraph JameNode.next ) }";

      public invariant "free <= collection"
    */
