...
public class JameUnitType extends JameMapType 
{
    ...
    public /*:readonly*/ static JameCollection unitTypes; 
	...
	/*:
	 modifies "unitTypes..JameCollection.collection"
	 ensures "newType : unitTypes..JameCollection.collection"
	 */
	{
		if( unitTypes == null )
	...
	/*:
	 ensures "result : unitTypes..JameCollection.collection & 
                  result..JameMapType.name = name"
	 */
	{
	    unitTypes.resetIter();
