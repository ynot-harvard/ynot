...
public class JameBuildCommand extends JameCommandContainer
{
    ...
    /*:
     requires	"( ALL b . b : JameMap.buildings..JameCollection.collection --> b..JameMapContainer.owner : JamePlayer.player..JameCollection.collection ) &
     			( ALL b . b : JameMap.buildings..JameCollection.collection --> b : b..JameMapContainer.owner..JamePlayer.buildings..JameCollection.collection ) &
     			( ALL p . p : alloc.JamePlayer --> p : JamePlayer.player..JameCollection.collection ) &     			
     			JameMap.initialised & this..JameCommandContainer.player..JamePlayer.resStore ~= null & this..JameCommandContainer.player ~= null & 
     			this..JameCommandContainer.player..JamePlayer.buildings ~= null & this..JameCommandContainer.player..JamePlayer.resStore..JameResourceSet.resources ~= null"
     modifies 	"JameMap.buildings..JameCollection.free", "JameMap.units..JameCollection.free", "JameMap.buildings..JameCollection.collection", "JameMap.buildings..JameCollection.size",
     			"this..JameCommandContainer.player..JamePlayer.buildings..JameCollection.collection", "this..JameCommandContainer.player..JamePlayer.buildings..JameCollection.size",
     ...
     ensures  	"( ALL b . b : JameMap.buildings..JameCollection.collection --> b..JameMapContainer.owner : JamePlayer.player..JameCollection.collection) &
     			( ALL b . b : JameMap.buildings..JameCollection.collection --> b : b..JameMapContainer.owner..JamePlayer.buildings..JameCollection.collection ) &
     			( ALL p . p : alloc.JamePlayer --> p : JamePlayer.player..JameCollection.collection )"
     */
    {
