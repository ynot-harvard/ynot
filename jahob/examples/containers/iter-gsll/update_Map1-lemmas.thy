theory "update_Map-lemmas"
imports "${PWD}/../../../lib/Jahob"
begin
...
apply force
apply (unfold "fieldWrite_def")
apply (unfold "fieldRead_def")
apply (unfold "Un_def")
apply safe
(* Does not like set comprehensions and I don't know how to eliminate them.
   ProofGeneral.call_atp
*)
